...
func ECDSAValidator(method jwt.SigningMethod, key *ecdsa.PublicKey, staticCheckFunc ...TokenCheckFunc) (TokenValidator, error) {
...
func (v *ecdsaValidator) Validate(token string, checkFunc ...TokenCheckFunc) error {
